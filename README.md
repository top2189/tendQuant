# A股全市场行情获取
个人量化开发必备，快速获取A股全市场5000+股票和 [场内ETF](./docs/etf.md) 的实时行情数据，点击 [tendQuant](https://tendquant.cn) 打开官网，开启你的量化研究之旅吧！
...
## 简介
tendQuant 是一个低门槛的 `A股` 行情数据服务平台，基于 MQTT 协议提供实时、稳定、高效的行情数据推送服务，提供全市场所有股票行情和场内ETF基金行情数据，`免费获取` 常见 A股 指数的实时行情数据。
...
| level 1  | [指数行情](./docs/index.md)   | lv1/index/{code}   | 单个指数行情快照   |
|          |            | lv1/index/#        | 常见指数行情快照    |
